...
Sprite1Info         byte ; スプライト情報
Sprite1Height       byte ; スプライトの高さを保持
Sprite1Gfx          word ; スプライトのアドレス
...
ZoneSprite1XPos     ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライトのX座標
ZoneSprite1Orients  ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライトの向き
ZoneSprite1Speeds   ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライトの速さ
ZoneSprite1Nusiz    ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライトのNUSIZ
ZoneSprite1Numbers  ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライトの番号
ZoneSprite2Colors   ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライト2の色
ZoneSprite2XPos     ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライト2のX座標
ZoneSprite2Orients  ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライト2の向き
ZoneSprite2Speeds   ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライト2の速さ
ZoneSprite2Nusiz    ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライト2のNUSIZ
ZoneSprite2Numbers  ds MAX_NUMBER_OF_ZONES ; 各ゾーンのスプライト2の番号
...
.SkipSprite{0}Animation
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ; Sprite2Infoが移動不可の場合はジャンプする
    MAC UnlessSprite2MovableThen
        lda Sprite2Info
        and #SPRITE_MOVABLE
        beq {0}
    ENDM
...
ProcZone
    ...
    LoadSpriteInfo 1
    UnlessSpriteMovableThen EndMove1
...
EndMove1
    ...
    ; SPRITE_MOVABLEでなければ移動処理はスキップ
    LoadSpriteInfo 2
    UnlessSprite2MovableThen EndMove2
...
ETGfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_ORIENTABLE | #16
    .byte %00000000 ; |        |
    .byte %11100111 ; |XXX  XXX|
    .byte %01100011 ; | XX   XX|
...
Walker1Gfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_ORIENTABLE | #19
    .byte %00000000 ; |        |
    .byte %00011100 ; |   ###  |
    .byte %00111110 ; |  ##### |
    .byte %01111100 ; | #####  |
...
Walker4Gfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_UNORIENTABLE | #8
    .byte   %00000000 ; |        |
    .byte   %11111111 ; |########|
    .byte   %10011001 ; |#  ##  #|
    .byte   %10011001 ; |#  ##  #|
...
Walker6Gfx:
    .byte #SPRITE_MOVABLE | #SPRITE_ANIMATABLE | #SPRITE_ORIENTABLE | #9
    .byte %00000000 ; |        |
    .byte %10100010 ; |X X   X |
...
Walker8Gfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_UNORIENTABLE | #7
    .byte %00000000 ; |        |
    .byte %11111111 ; |XXXXXXXX|
    .byte %11111111 ; |XXXXXXXX|
    .byte %01111110 ; | XXXXXX |
...
Dragonstomper1Gfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_UNORIENTABLE | #20
    .byte %00000000 ; |        |
    .byte %00011000 ; |   XX   |
    .byte %00111100 ; |  XXXX  |
    .byte %00111100 ; |  XXXX  |
...
Dragonstomper2Gfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_UNORIENTABLE | #16
    .byte %00000000 ; |        |
...
Dragonstomper3Gfx:
    .byte #SPRITE_UNMOVABLE | #SPRITE_UNANIMATABLE | #SPRITE_UNORIENTABLE | #12
    .byte %00000000 ; |        |
    .byte %11001100 ; |XX  XX  |
    .byte %01001000 ; | X  X   |
    .byte %01111000 ; | XXXX   |
