...
GetRandomJetXPos subroutine
    ...
    sta JetXPos           ; save it to the variable JetXPos

    rts
    
GetRandomJetYPos subroutine
    lda Random
    asl
    eor Random
    asl
    ...
    sta JetYPos           ; save it to the variable JetXPos
